namespace Msa.Seeder.Azure.Interface.Storage
{
    ...
    public class StorageAuthHelper
    {
        /// <summary>
        ...
        /// <param name="timestamp">Date/Time stamp for now.</param>
        ...
        //     AuthenticationHeaderValue authHV = new AuthenticationHeaderValue(
        //         "SharedKey",
           ...
           String md5 = "")
        {
            ...
            String MessageSignature = String.Format("{0}\n{1}\n\n{3}\n{4}",
                      ...
                      contentType,
                      timestamp,
                      GetCanonicalizedResource(requestUri, storageAccountName));
